...
const auto& GetTestCaseDefinitions() {
    static const std::vector<TestCaseDefinition> testCases = {
        ...
        {"hotkey-runtime-hold-specific-shift-bit30-keydown-activates-exact-side", &RunHotkeyRuntimeHoldSpecificShiftBit30KeydownActivatesExactSideTest},
        {"hotkey-runtime-single-shift-bit30-keydown-activates-exact-side", &RunHotkeyRuntimeSingleShiftBit30KeydownActivatesExactSideTest},
        {"hotkey-runtime-single-shift-repress-after-specific-shift-release-uses-exact-tracker",
         &RunHotkeyRuntimeSingleShiftRepressAfterSpecificShiftReleaseUsesExactTrackerTest},
        {"hotkey-runtime-specific-shift-wrong-keyup-uses-lowlevel-exact-state",
         &RunHotkeyRuntimeSpecificShiftWrongKeyupUsesLowLevelExactStateTest},
        {"hotkey-runtime-single-shift-wrong-keyup-releases-from-resolved-vk",
         &RunHotkeyRuntimeSingleShiftWrongKeyupReleasesFromResolvedVkTest},
        {"hotkey-runtime-hold-specific-shift-release-reverts-on-non-main-keyup", &RunHotkeyRuntimeHoldSpecificShiftReleaseRevertsOnNonMainKeyupTest},
        {"key-rebind-runtime-specific-shift-bit30-keydown-uses-exact-vk", &RunKeyRebindRuntimeSpecificShiftBit30KeydownUsesExactVkTest},
